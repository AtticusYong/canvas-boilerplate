...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.p + "9801d2a2dccb5a027e694191e80a5b93.png");
...
/* harmony import */ var _img_platformSmall_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../img/platformSmall.png */ "./src/img/platformSmall.png");
...
var platformSmallImage = createImage(_img_platformSmall_png__WEBPACK_IMPORTED_MODULE_4__["default"]);
...
function init() {
  ...
  platforms = [new Platform({
    x: platformImage.width * 4 + 798 + platformImage.width - platformSmallTallImage.width,
    y: 300,
    ...
    x: platformImage.width * 7 + 348,
    y: 470,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 6 + 198 + platformImage.width - platformSmallTallImage.width,
    y: 270,
    image: platformSmallTallImage
  }), new Platform({
    x: platformImage.width * 8 + 648,
    y: 370,
    image: platformImage
  }), // repeat
  new Platform({
    x: platformImage.width * 12 + 798 + platformImage.width - platformSmallTallImage.width,
    y: 300,
    image: platformSmallTallImage
  ...
  new Platform({
    ...
    x: platformImage.width * 12 + 298,
    y: 370,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 15 + 348,
    y: 470,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 14 + 198 + platformImage.width - platformSmallTallImage.width,
    y: 270,
    image: platformSmallTallImage
  }), new Platform({
    x: platformImage.width * 16 + 648,
    y: 370,
    image: platformImage
  }), // repeat
  new Platform({
    x: platformImage.width * 19 + 798 + platformImage.width - platformSmallTallImage.width,
    y: 300,
    image: platformSmallTallImage
  }), // new Platform({ x: -1, y: 470, image: platformImage }),
  // new Platform({ x: platformImage.width * 17 + 200, y: 275, image: platformSmallImage }),
  new Platform({
    x: platformImage.width * 18 + 200,
    y: 200,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 19 + 298,
    y: 370,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 22 + 348,
    y: 470,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 21 + 198 + platformImage.width - platformSmallTallImage.width,
    y: 270,
    image: platformSmallTallImage
  }), new Platform({
    x: platformImage.width * 23 + 648,
    y: 370,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 24 + 648,
    y: 370,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 25 + 648,
    y: 370,
    image: platformImage
  }), new Platform({
    x: platformImage.width * 26 + 648,
    y: 370,
    image: platformImage
  })];
